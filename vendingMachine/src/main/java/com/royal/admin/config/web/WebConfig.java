...
import com.royal.admin.core.listener.ConfigListener;
...
import static com.royal.admin.core.common.constant.Const.API_NONE_PERMISSION_RES;
import static com.royal.admin.core.common.constant.Const.NONE_PERMISSION_RES;
...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(new RestApiInteceptor()).excludePathPatterns(API_NONE_PERMISSION_RES).addPathPatterns("/gunsApi/**");
    ...
    public JdkRegexpMethodPointcut druidStatPointcut() {
        ...
        String patterns = "com.royal.admin.modular.*.service.*";
        //可以set多个
