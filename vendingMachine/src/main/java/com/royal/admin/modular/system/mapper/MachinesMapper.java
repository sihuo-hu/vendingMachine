...
public interface MachinesMapper extends BaseMapper<Machines> {
    Page<Map<String, Object>> selectMachines(@Param("page") Page page, @Param("machinesId") String machinesId, @Param("machinesName") String machinesName, @Param("onlineStatus") String onlineStatus);

    /**
     * 修改设备状态
     */
    int setStatus(@Param("machinesId") String machinesId, @Param("onlineStatus") String onlineStatus);
//
//    /**
//     * 修改密码
//     */
